...
public:
	...
	public:
		...
		virtual const std::list<std::string> &W1devices() const = 0; // return current list of devices
	...
	MeterW1therm (const std::list<Option> &options, W1HWif *hwif=0); // class takes ownership of hwif. Can be 0 in this case will default to W1syshwif
